...
public class PanelLetras extends JPanel implements Runnable, ActionListener {
    ...
    public PanelLetras(String nombreJugador1) {
        Random = new Random();
        this.setPreferredSize(new Dimension(Ancho, Alto));
        this.setBackground(Color.BLACK);
        this.addKeyListener(new Controles2());
        this.setFocusable(true);
        this.requestFocusInWindow();
        this.nombreJugador1 = nombreJugador1;
        JLabel nombresJugadores1Label = new JLabel("Jugador: " + nombreJugador1);
        nombresJugadores1Label.setForeground(Color.white);
        nombresJugadores1Label.setFont(new Font("Sans serif", Font.PLAIN, 25));
        nombresJugadores1Label.setHorizontalAlignment(JLabel.CENTER);
        nombresJugadores1Label.setBounds(Ancho - nombresJugadores1Label.getPreferredSize().width - 40, 0, nombresJugadores1Label.getPreferredSize().width, 30);
        this.add(nombresJugadores1Label);
    ...
    public class Controles2 extends KeyAdapter {
